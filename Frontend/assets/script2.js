...
// const tweets = [
//  "Pet food (dog/cat dry mix) and 25 portable crates available for distribution in Panaji, Goa. For rescue teams.",
// "Looking for oxygen support and saline drips in Motihari, Bihar. Medical team overwhelmed.",
// "Free charging points and torches (50+ sets) available in Surat, Gujarat. Power backup also provided.",
// "Need clean water bottles and energy drinks in Baripada, Odisha. Many showing signs of dehydration.",
// "Badly need soap, disinfectants, and masks in Bhadrak, Odisha. Disease risk rising.",
// "Need glucose, ORS, and dry snacks in Kishoreganj, West Bengal. Elderly are fainting.",
// "Clean drinking water (1200 bottles) and ORS packets available at the community hall in Kochi, Kerala.",
// "Urgent need for 100 tarpaulin sheets and ropes in Krishnanagar, West Bengal. Families exposed to rain.",
// "Requesting 150 packs of glucose biscuits for displaced children in Jamtara, Jharkhand.",
// "1000 packets of biscuits, glucose powder, and dry fruits available in Nagpur, Maharashtra. Near medical college.",
// "Urgent need for torches, candles, and batteries in Araria, Bihar. No power for 3 days.",
// "Dry baby cereal, fruit puree packs, and mineral water available at child support center in Udaipur, Rajasthan.",
// "Desperately looking for 100 insulin vials and 50 BP kits in Bhagalpur, Bihar. Patients unable to travel.",
// "Available: 300 mosquito nets and 100 bottles of mosquito repellent at the shelter in Jaipur, Rajasthan.",
// "Please send 20 power banks and USB lights to Katihar, Bihar. Still no electricity in area.",
// "Require baby formula, warm clothes, and blankets in Nagaon, Assam. Infants and elderly are vulnerable.",
// "NGO distributing baby diapers, wet wipes, and powdered milk near railway station in Kanpur, Uttar Pradesh.",
// "Power banks and mobile charging facilities needed in Malda, West Bengal. Connectivity lost.",
// "100 blankets needed in Sahebganj, Jharkhand. Children sleeping in open areas.",
// "Urgently need 20 stretchers and wheelchairs in Muzaffarpur, Bihar. Elderly stuck in buildings.",
// "200 tins of baby food and 150 packs of infant formula available in Indore, Madhya Pradesh. Contact local NGO.",
// "Requesting stretchers and wheelchairs for injured people in Banka, Bihar. Roads inaccessible.",
// "Community kitchen in Guwahati (non-flooded zone) offering rice meals and medical support to all evacuees.",
// "Need urgent supply of clean drinking water in Dhubri, Assam. Wells are contaminated.",
// "Can someone provide 200 sanitary pads and soap bars in Tezpur, Assam? Hygiene issues rising.",
// "Stock of paracetamol, ORS, and bandages ready in Lucknow, Uttar Pradesh. Come to Red Cross center.",
// "Medical team with insulin, BP meds, and first-aid supplies stationed in Bhopal, Madhya Pradesh. Walk-ins allowed.",
// "Can someone help with 300 sanitary napkins in Murshidabad, West Bengal? Hygiene crisis in camps.",
// "Please send adult diapers and walking sticks to Purulia, West Bengal. Elderly stranded in camp.",
// "NGO in Ranchi, Jharkhand has antiseptics, Dettol, Betadine, and pain relief sprays. Visit health desk.",
// "Any help with pet food and crates in Agartala, Tripura? Abandoned animals struggling to survive.",
// "NGO in Ahmedabad, Gujarat has 500 sanitary pads, 200 soaps, and women’s hygiene kits. Available 10 AM–5 PM.",
// "Immediate requirement of 500 food packets in Goalpara, Assam. No access to groceries.",
// "Freshly cooked food and warm drinking water being served in Gangtok, Sikkim from 12 PM–4 PM daily.",
// "Please send ropes and life jackets to Cooch Behar, West Bengal. Water level rising.",
// // "Looking for 150 mosquito nets and repellents in Raiganj, West Bengal. Dengue cases rising.",
// // "Require baby food, bottles, and formula in Dumka, Jharkhand. Flood hit area cut off.",
// // "Community shelter in Visakhapatnam, Andhra Pradesh offering meals and 400 blankets. Contact SEVA volunteers.",
// // "Stranded families in Darrang, Assam need rice, dal, and cooking oil. No relief received yet.",
// // "100 packs of glucose biscuits and 60 jars of peanut butter available at shelter in Dehradun, Uttarakhand.",
// // "Life jackets, rubber boats, and rescue ropes stored in Port Blair, Andaman & Nicobar Islands. Emergency pickup only.",
// // "Stock of salt, sugar, oil, and wheat flour (ration kits) prepared in Thrissur, Kerala. Available from local temple trust.",
// // "Water purifiers and chlorine tablets needed in Barpeta, Assam. Flu cases increasing.",
// // "Desperate for 300 packets of dry ration in Bargarh, Odisha. Shops shut due to flood.",
// // "Available: 200 raincoats and plastic sheets for temporary shelter use in Shimoga, Karnataka. From 9 AM daily.",
// // "Looking for volunteers to help distribute supplies in Katihar, Bihar. Local teams exhausted.",
// // "1000 kg of rice and 500 kg of dal at the relief center in Amritsar, Punjab. Volunteers on-site.",
// // "Please send 200 packets of baby diapers and wipes to Balurghat, West Bengal. Families stuck in shelters.",
// // "In desperate need of first aid kits and antiseptics in Pakur, Jharkhand. Minor injuries untreated.",
// // "Need 100 mosquito nets and coils in Jalpaiguri, West Bengal. Stagnant water all around.",
// // "Any help with raincoats and plastic sheets in Munger, Bihar? Continuous downpour worsening.",
// // "Require oxygen cylinders and glucose drips in Kishanganj, Bihar for trapped patients.",
// // "100 families need tarps and bamboo poles in Hailakandi, Assam for temporary shelter setup."
// ];
...
  if (tweetData.length === 0) {
    tweetList.innerHTML = `<h4 style="color: black; text-align: center;">No Tweets</h4>`;
    return;
  }

  tweetList.innerHTML = ""; // Clear previous content
